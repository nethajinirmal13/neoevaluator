	...
	if request.user.is_authenticated:
		...
		if (userTemp==None):
			try:
				...
				userTemp=None
		if (usertype=="Faculty"):
			return render(None,"faculty.html",{'faculty':userTemp})
			...
			return render(None,"student.html",{'student':userTemp,'courses':courses,'credits':credits,'grade_arr':grade_arr,'sgpa':sgpa,'pr':pr})
		else :
